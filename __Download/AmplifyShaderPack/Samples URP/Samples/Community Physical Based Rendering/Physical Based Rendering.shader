	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_output_15_0_g61277 = ase_viewDirWS;
				...
				float3 normalizeResult447_g61329 = ASESafeNormalize( ( ase_viewDirSafeWS + SafeNormalize(_MainLightPosition.xyz) ) );
				...
				float3 normalizeResult176_g61185 = normalize( ( SafeNormalize(_MainLightPosition.xyz) + ase_viewDirSafeWS ) );
				...
				float3 bakedGI607_g1 = ASEBakedGI( WorldPosition, WorldNormalTangent1160_g1, ( uint2 )( ase_positionSSNorm.xy * _ScreenSize.xy ), (input.ase_texcoord4.zw*(unity_LightmapST).xy + (unity_LightmapST).zw), (input.ase_texcoord8.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw), true);
...
ASEEND*/
//CHKSM=DA632F428D5FE45B61CFBF4120E5D626F0264B85