...
#warning Adaptive Probe Volumes are in use, this is not supported. Probe occlusion will not affect the grass surface.
#endif
...
Varyings LitPassVertex(Attributes input)
{
	...
	OUTPUT_SH4(vertexData.positionWS, output.normalWS.xyz, GetWorldSpaceNormalizeViewDir(vertexData.positionWS), output.vertexSH, probeOcclusion);
